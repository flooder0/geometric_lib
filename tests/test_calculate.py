...
class TestCalculator(unittest.TestCase):
    def test_circle_perimeter(self):
        self.assertAlmostEqual(
            calc("circle", "perimeter", [5]), 31.41592653589793, "Error in Perimeter calculating"
        )
    ...
    def test_circle_area(self):
        self.assertAlmostEqual(
            calc("circle", "area", [5]), 78.53981633974483, "Error in Area calculating"
        )
    ...
    def test_triangle_area(self):
        self.assertAlmostEqual(
            calc("triangle", "area", [3, 4, 5]), 6, "Error in Area calculating"
        )
